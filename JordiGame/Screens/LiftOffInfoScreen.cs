...
{
    public class LiftOffInfoScreen : StateManagement.GameScreen
    {
        ...
        public override void Draw(GameTime gameTime)
        {
            ...
            spriteBatch.DrawString(_gameFont, "YOU WIN! Press Esc to Finish the Game!",
                                   _enemyPosition, Color.White);
